...
class ReplayVersion6Offsets(ReplayOffsets):
    ...
    def extract_sniper_username(self, bytes):
        ...
        return self._read_bytes(bytes, 0x64 + spy_username_length, sniper_username_length)
    ...
    def extract_spy_display_name(self, bytes):
        ...
        if spy_displayname_length == 0:
            ...
            return self._read_bytes(bytes, 0x64 + spy_username_length + sniper_username_length, spy_displayname_length)
